...
class claimedDocumentController extends Controller
{
    public function index()
    {
        $documents = lostDocuments::join('countries', 'lost_documents.country_id', 'countries.id')
            ...
            )->where('lost_documents.status', 3)->orderBy('lost_documents.id', 'DESC')->get();
        return view('admin.claimedDocuments.index')->with('documents', $documents);
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.claimedDocuments.view')->with('document', $documents);
    }
