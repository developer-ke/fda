...
class correspondentController extends Controller
{
    ...
    public function profile()
    {
        ...
        return view('correspondent.profile.index')->with('user', $this->showProfile(Auth::user()->id));
    }

    public function EditProfile()
    {
        return view('correspondent.profile.edit')->with([
    ...
    {
        return view('correspondent.index')->with([
