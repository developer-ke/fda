                                            ...
                                            <div class="dropdown open">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end text-capitalize"
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.claimedDocuments.show', ['document_id' => $document->id]) }}">
                                                        <i class="bi bi-eye"></i>
                                                        view
                                                    </a>
                                                    <form
                                                        action="{{ route('admin.claimedDocuments.destroy', ['document_id' => $document->id]) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
