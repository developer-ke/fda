    ...
    <div class="mt-2">
        <div class="card">
            <div class="card-header">
                <span>
                    <a href="{{ route('admin.myDrawer.create') }}" class="btn fda-bg text-white">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="my-dropdown">
                                                <a class="dropdown-item text-capitalize"
                                                    href="{{ route('admin.myDrawer.view', ['drawer_id' => $drawer->id]) }}">
                                                    <i class="fa fa-eye"></i>
                                                    view
                                                </a>
                                                <a class="dropdown-item text-capitalize  @if ($drawer->status === 0 || $drawer->status === 2) d-none @endif"
                                                    href="{{ route('admin.myDrawer.edit', ['drawer_id' => $drawer->id]) }}">
                                                    <i class="fa fa-pencil-square"></i>
                                                    edit
                                                </a>
                                                <form
                                                    action="{{ route('admin.myDrawer.lost', ['drawer_id' => $drawer->id]) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('PUT')
                                                    <button
                                                ...
                                                <form
                                                    action="{{ route('admin.myDrawer.found', ['drawer_id' => $drawer->id]) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('PUT')
                                                    <button
