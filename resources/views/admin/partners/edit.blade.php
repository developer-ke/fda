                ...
                <div class="row mx-auto">
                    <div class="col-12 col-md-6">
                        <div class="card shadow-none border-1 h-100">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.partner.update', ['partner_id' => $partner->id]) }}"
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card shadow-none border-1 h-100">
                            ...
                            <div class="card-body d-flex align-items-center">
                                <img id="preview" src="{{ asset('assets/cms/' . $partner->logo) }}" alt=""
                                    class="mx-auto" height="200px" width="200px">
                            </div>
                        </div>
                    </div>
                </div>
