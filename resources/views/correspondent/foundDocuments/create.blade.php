...
@section('content')
    <div class="card shadow-none mt-2">
        <div class="card-header">
            <span>
                <a href="{{ route('correspondent.foundDocuments') }}">
        ...
        <div class="card-body">
            ...
            <form class="form-header" action="{{ route('report_found_document') }}" class="form-header" id="freport-form"
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-outline">
                            <input class="form-control " name="document_serial_number" id="fserialno" type="text"
                                placeholder="Enter Document/Serial No" required value="{{ old('document_serial_number') }}">
                        </div>
                    ...
                    <div class="col-12 col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-outline">
                            <input class="form-control" name="longitude" id="longitude" type="text"
                                placeholder="longituder" required value="{{ old('longitude') }}" readonly>
                        </div>
                        @error('longitude')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-12 col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-outline">
                            <input class="form-control" name="Owners_first_name" id="fownerfirstname" type="text"
                                placeholder="Owner's first name" required value="{{ old('Owners_first_name') }}">
                        </div>
                    ...
                    <div class="col-12 col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-outline">
                            <input class="form-control" name="Owners_last_name" id="fownerlastname" type="text"
                                placeholder="Owner's last name" required value="{{ old('Owners_last_name') }}">
                        </div>
                    ...
                    <div class="col-12 col-md-4 mb-3" hidden>
                        ...
                        <div class="input-group input-group-outline">
                            <input class="form-control " name="email_address" id="femailaddress" type="email"
                                placeholder="Your email" value="{{ old('email_address') ?? Auth::user()->email }}"
                                required>
                        </div>
                        @error('email_address')
                            <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-12 col-md-4 mb-3" hidden>
                        ...
                        <div class="input-group input-group-outline">
                            <input class="form-control " name="fcountrycode" id="fcountrycode" type="text"
                                placeholder="Code" value="{{ old('fcountrycode') ?? $user->code }}" required>
                        </div>
                        @error('fcountrycode')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-12 col-md-4 mb-3" hidden>
                        ...
                        <div class="input-group input-group-outline">
                            <input class="form-control " name="phone_number" id="fphonenumber" type="text"
                                placeholder="Phone number" value="{{ old('phone_number') ?? $user->phoneNumber }}"
                                required>
                        </div>
                        @error('phone_number')
                            <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-12 col-md-4 mb-3 mt-1">
                        <button class="btn fda-bg text-white mt-4 w-100">submit</button>
                    </div>
                </div>
            </form>
        </div>
