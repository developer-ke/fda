    ...
    <div class="mt-2">
        <div class="card shadow-none">
            <div class="card-header">
                <a href="{{ route('correspondent.foundDocuments.create') }}" class="btn fda-bg text-white">
                                            ...
                                            <div class="dropdown open">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end text-capitalize"
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('correspondent.foundDocuments.edit', ['document_id' => $document->id]) }}">
                                                        <i class="bi bi-pencil-square"></i>
                                                        edit
                                                    </a>
                                                    <a class="dropdown-item"
                                                        href="{{ route('correspondent.foundDocuments.view', ['document_id' => $document->id]) }}">
                                                        <i class="bi bi-eye"></i>
                                                        view
                                                    </a>
                                                    <form
                                                        action="{{ route('correspondent.foundDocuments.destroy', ['document_id' => $document->id]) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
