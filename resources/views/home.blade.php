    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="d-flex">
                    <div class="me-1">
                        <img src="{{ asset('uploads/profiles/' . Auth::user()->image) }}" class="avatar avatar-sm"
                            alt="">
                    </div>
                    <div class="d-flex flex-column py-0">
                        <h4 class="form-check-label mb-0">{{ Auth::user()->name }}</h4>
                        <p class="form-check-label mt-0">{{ Auth::user()->email }}</p>
                    </div>
                </div>
                                                ...
                                                @foreach ($partners as $partner)
                                                    <div class="col-md-3">
                                                        <a href="#" class="thumbnail">
                                                            <img src="{{ asset('assets/cms/' . $partner->logo) }}"
                                                                alt="Image" id='img3'>
                                                        </a>
                                                    </div>
                                                @endforeach
