...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content border-radius-lg">
        <!-- Navbar -->
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-auto border-radius-xl shadow-none position-sticky blur shadow-blur mt-2 left-auto top-1 z-index-sticky"
            ...
            <div class="container-fluid py-1 mx-auto">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        <li class="breadcrumb-item text-sm text-capitalize"><a class="opacity-5 text-dark"
                                href="javascript:;">admin</a></li>
                        <li class="breadcrumb-item text-sm text-dark active text-capitalize" aria-current="page">index
                        </li>
                    </ol>
                </nav>
