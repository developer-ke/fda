...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-2 fixed-start ms-2"
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="{{ route('subscriber') }}" target="_blank">
        ...
        <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('subscriber') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('subscriber.drawer') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="opacity-10">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('subscriber.foundDocuments') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="opacity-10">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('subscriber.lostDocuments') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="opacity-10">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white text-capitalize " href="{{ route('subscriber.profile') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <li class="nav-item dropdown mx-3 d-flex align-items-center">
                            ...
                            <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
                                ...
                                @if (session()->has('lostdocs'))
                                    <li class="mb-2">
                                        <a class="dropdown-item border-radius-md"
                                            href="{{ route('subscriber.lostDocuments') }}">
                                ...
                                @if (session()->has('userFoundDocs'))
                                    <li class="mb-2">
                                        <a class="dropdown-item border-radius-md"
                                            href="{{ route('subscriber.foundDocuments') }}">
                                            <div class="d-flex py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="text-sm font-weight-normal mb-1">
