    ...
    <div class="mt-2">
        <div class="card shadow-none">
            <div class="card-header">
                <span>
                    <a href="{{ route('subscriber.drawer.create') }}" class="btn fda-bg text-white">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="my-dropdown">
                                                <a class="dropdown-item text-capitalize"
                                                    href="{{ route('subscriber.drawer.show', ['drawer_id' => $drawer->id]) }}">
                                                    <i class="fa fa-eye"></i>
                                                    view
                                                </a>
                                                <a class="dropdown-item text-capitalize  @if ($drawer->status === 0 || $drawer->status === 2) d-none @endif"
                                                    href="{{ route('subscriber.drawer.edit', ['drawer_id' => $drawer->id]) }}">
                                                    <i class="fa fa-pencil-square"></i>
                                                    edit
                                                </a>
                                                <form
                                                    action="{{ route('subscriber.drawer.lost', ['drawer_id' => $drawer->id]) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('PUT')
                                                    <button
                                                ...
                                                <form
                                                    action="{{ route('subscriber.drawer.found', ['drawer_id' => $drawer->id]) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('PUT')
                                                    <button
                                                ...
                                                <form
                                                    action="{{ route('subscriber.drawer.destroy', ['drawer_id' => $drawer->id]) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button
