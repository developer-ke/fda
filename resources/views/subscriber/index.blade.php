    ...
    <div class="row mt-3">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 mt-sm-0 mb-4">
            <div class="card h-100">
                <div class="card-header p-3 pt-2">
                    <div
                        class="icon icon-lg icon-shape bg-info shadow-primary shadow text-center border-radius-xl mt-n4 position-absolute">
                        <i class="bi bi-file-earmark-medical"></i>
                    </div>
                    <div class="text-end pt-1">
                ...
                <hr class="dark horizontal my-0">
                <div class="card-footer p-3">
                    <p class="mb-0 text-center">found documents</p>
                </div>
            </div>
        </div>
    </div>
