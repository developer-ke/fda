...
Route::prefix('/correspondent')->middleware(['auth', 'access', 'correspondent', 'profile', 'notifications'])->group(function () {
...
// subscriber routes
Route::prefix('/subscriber')->middleware(['auth', 'access', 'subscriber', 'profile', 'notifications'])->group(function () {
